...
shulian1 = []
chenshi1 = []
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_1_.csv", "r", encoding="utf-8") as f:
...
bar1.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\todo1.html')
print("todo1完成！")
# todo 2 全国大数据行业中对学历的要求比例
shulian2 = []
xueli2 = []
sepdata2 = []
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_2_.csv", "r", encoding="utf-8") as f1:
...
bar2 = (
    ...
    Bar(init_opts=opts.InitOpts(width='900px'))
        ...
        .set_global_opts(title_opts=opts.TitleOpts(title="全国大数据行业中对学历的要求比例柱形图",pos_right="center",
                                                   title_textstyle_opts=opts.TextStyleOpts(font_size=30)),
                         xaxis_opts=opts.AxisOpts(axislabel_opts=opts.LabelOpts(interval=0, rotate=30)),
                         legend_opts=opts.LegendOpts(is_show=False))
)
...
page.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\todo2.html')
print("完成！")
...
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_3_.csv", "r", encoding="utf-8") as f:
    for i in f.readlines():
        into = i.strip()
...
bar3.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\todo3.html')
print("todo3完成！")
# # todo 4 大数据专业使用最广泛的技术排名top20
jishu4 = []
shul4 = []
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\使用数量最多的技术.csv", "r", encoding="utf-8") as f:
...
page4.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\技术排名top20.html')
print("todo4完成！")
...
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_5_.csv", "r", encoding="utf-8") as f:
    for i in f.readlines():
        xinzi5.append(float(i.split(",")[0]))
        chenshi_5.append(i.split(",")[1].strip())
print(xinzi5)
print(chenshi_5)
shul5 = []
chenshi5 = []

with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_3_.csv", "r", encoding="utf-8") as f2:
...
bar5 = (  # 将整个过程代码赋值给bar
    ...
    .set_series_opts(markline_opts=opts.MarkLineOpts(
            data=[opts.MarkLineItem(type_="average", name="平均值",symbol_size=10,symbol=".")]
        ))
...
grid5.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\todo5.html')
print("todo5完成")
...
with open(r"D:\LJH\local\python\项目\项目三\web\djangoProject\app\data\_todo_6_.csv", "r", encoding="utf-8") as f:
    for i in f.readlines():
...
bar6.render(r'D:\LJH\local\python\项目\项目三\web\djangoProject\templates\todo6.html')
print("todo6完成")
